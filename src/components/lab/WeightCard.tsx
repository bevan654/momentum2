  ...
  if (Math.abs(remaining) < 0.1) {
    return (
      <View style={styles.goalSection}>
        ...
        <Text style={[styles.goalText, { color: colors.accentGreen }]}>Goal reached!</Text>
...
const WeightChart = React.memo(function WeightChart({
  ...
  return (
    <Svg width={chartWidth} height={CHART_HEIGHT}>
      ...
      <SvgText x={CHART_PADDING_LEFT - sw(6)} y={yForWeight(maxW) + 4} fill={colors.textTertiary} fontSize={ms(10)} textAnchor="end">{maxW}</SvgText>
      <SvgText x={CHART_PADDING_LEFT - sw(6)} y={yForWeight(midW) + 4} fill={colors.textTertiary} fontSize={ms(10)} textAnchor="end">{midW}</SvgText>
      <SvgText x={CHART_PADDING_LEFT - sw(6)} y={yForWeight(minW) + 4} fill={colors.textTertiary} fontSize={ms(10)} textAnchor="end">{minW}</SvgText>
